package Tema5.ejercicios.StockElectroAvila;
...
public class GestionInventario {
    public static void main(String[] args) {
        ...
        Set<Producto> productosUnicos = new HashSet<>(entradaAlmacen); // Completar
        ...
        Iterator<Producto> it = listaLimpia.iterator();
        ...
        listaLimpia.sort((a, b) -> b.getStock() - a.getStock());
